...
namespace Plugin.XSnack
{
    ...
    public interface IXSnack
    {
        ...
        /// <returns></returns>
        Task ShowMessageAsync(string message, int duration = 5, string actionText = null, ICommand actionCommand = null);
        ...
        /// <param name="actionCommand">Callback command for the action button (optional)</param>
        /// <returns></returns>
        void ShowMessage(string message, int duration = 5, string actionText = null, ICommand actionCommand = null);
    }
}
